    ...
    return (
      <div id="test">
		...
		<div className="container text-center">
			<h1>Moving You Forward<span className="m_1">Stream Selection and Planning for Class 8-9.</span></h1>
			<a href="#" className="hover-btn-new"><span>Enquire Now</span></a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <div className="col-md-6">
                                    ...
                                    <div className="pricing-table">
                                        ...
                                        <div className="pricing-table-features">
                                            <p><i className="fa fa-calendar-times-o"></i> <strong>Duration</strong> 1hr</p>
                                            <p><i className="fa fa-money"></i> <strong>Price</strong> 5000</p>
                                            <p><i className="fa-location-arrow"></i> <strong>Location</strong> Taj Nagri</p>
                                            <p><i className="fa fa-link"></i> <a href="">Full Detail</a>    </p>
                                        </div>
                                        <div className="pricing-table-sign-up">
                                            <a href="#" className="hover-btn-new orange"><span>Book Now</span></a>
                                        </div>
                                    </div>
                                </div>
								<div className="col-md-6">
                                    <div className="pricing-table pricing-table-highlighted">
										<div className="testi-meta">
											<img src={require("../images/test_side_image.png")} alt="" className="img-fluid"></img>
										</div>
                                    </div>
                                </div>
                            </div>
